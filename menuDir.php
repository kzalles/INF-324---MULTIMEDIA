			    ...
			    <ul class="navbar-nav">
			      ...
			      <li class="nav-item dropdown">
			        ...
			        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
			          <a class="dropdown-item" href="RegistrarEst.php">Registrar</a>
			          <a class="dropdown-item" href="mostrar-sesionDir.php">Estudiantes
			          	<ul class="list-group list-group-flush">
						    <li class="list-group-item"><a class="list-group-item" href="#INF324">INF 324</a></li>
						    <li class="list-group-item"><a class="list-group-item" href="#INF315">INF 315</a></li>
						    <li class="list-group-item"><a class="list-group-item" href="#INF351">INF 351</a></li>
						</ul>
			          </a>
			          <a class="dropdown-item" href="mostrar-sesionDir2.php">Promedios</a>
			        </div>
			      </li>
			      <li class="nav-item">
